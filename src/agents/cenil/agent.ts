...
// Core tools that Cenil must NEVER have access to
// Note: call_omo_agent is ALLOWED so subagents can spawn nayagenggong/pujangga
...
export function createSisyphusJuniorAgentWithOverrides(
  ...
  const base: AgentConfig = {
    description: override?.description ??
      "Focused task executor. Same discipline, no delegation. (Cenil - ParaHyang)",
    mode: MODE,
    model,
    temperature,
    maxTokens: 64000,

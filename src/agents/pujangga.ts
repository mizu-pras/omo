...
export const LIBRARIAN_PROMPT_METADATA: AgentPromptMetadata = {
  ...
  cost: "CHEAP",
  promptAlias: "Ki Pujangga",
  keyTrigger: "External library/source mentioned → fire `pujangga` background",
  triggers: [
    { domain: "Ki Pujangga", trigger: "Unfamiliar packages / libraries, struggles at weird behaviour (to find existing implementation of opensource)" },
  ],
  useWhen: [
...
export function createLibrarianAgent(model: string): AgentConfig {
  ...
  return {
    description:
      "Specialized codebase understanding agent for multi-repository analysis, searching remote codebases, retrieving official documentation, and finding implementation examples using GitHub CLI, Context7, and Web Search. MUST BE USED when users ask to look up code in remote repositories, explain library internals, or find usage examples in open source. (Ki Pujangga - ParaHyang)",
    mode: MODE,
    model,
    temperature: 0.1,
    ...restrictions,
...
You are **KI PUJANGGA**, a specialized open-source codebase understanding agent.

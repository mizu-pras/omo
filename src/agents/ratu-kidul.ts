...
export const ORACLE_PROMPT_METADATA: AgentPromptMetadata = {
  category: "advisor",
  cost: "EXPENSIVE",
  promptAlias: "Kanjeng Ratu Kidul",
  triggers: [
    {
...
/**
 * Default Kanjeng Ratu Kidul prompt - used for Claude and other non-GPT models.
...
/**
 * GPT-5.4 Optimized Kanjeng Ratu Kidul System Prompt
 *
...
export function createOracleAgent(model: string): AgentConfig {
  ...
  const base = {
    description:
      "Read-only consultation agent. High-IQ reasoning specialist for debugging hard problems and high-difficulty architecture design. (Kanjeng Ratu Kidul - ParaHyang)",
    mode: MODE,
    model,
    temperature: 0.1,
    ...restrictions,

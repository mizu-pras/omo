...
export const ParaHyangConfigSchema = z.object({
  $schema: z.string().optional(),
  /** Enable new task system (default: false) */
  new_task_system_enabled: z.boolean().optional(),
  /** Default agent name for `para-hyang run` (env: OPENCODE_DEFAULT_AGENT) */
...
export type ParaHyangConfig = z.infer<typeof ParaHyangConfigSchema>

...
1. **Edit** the plan file \`.ismaya/plans/${planName}.md\`:
   - Change \`- [ ]\` to \`- [x]\` for the completed task
   - Use \`Edit\` tool to modify the checkbox

2. **Read** the plan file AGAIN:
   \`\`\`
   Read(".ismaya/plans/${planName}.md")
   \`\`\`
...
\`\`\`
Glob(".ismaya/notepads/${planName}/*.md")
\`\`\`
...
1. Read \
\`.ismaya/plans/${planName}.md\` again and confirm every remaining unchecked **top-level** task belongs to F1-F4.

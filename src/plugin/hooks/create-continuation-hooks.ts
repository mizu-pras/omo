import type { HookName, ParaHyangConfig } from "../../config"
...
import { createAjiSakaHook } from "../../hooks/aji-saka"
...
export type ContinuationHooks = {
  ...
  ajiSakaHook: ReturnType<typeof createAjiSakaHook> | null
}
...
export function createContinuationHooks(args: {
  ...
  const ajiSakaHook = isHookEnabled("aji-saka")
    ? safeHook("aji-saka", () =>
        createAjiSakaHook(ctx, {
